const { getAllVideogames, getVideogameByName, getVideogameById, postNewVideogame, makeRelationship } = require("../controllers/videogamesControllers");
...
const {genreId,name,description,platforms,background_image,released,rating} = req.body;

    try {
        const response = await postNewVideogame(name,description,platforms,background_image,released,rating);
